...
describe('todoService', () => {
    ...
    describe('#create', () => {
        ...
        it('should save todo item with late status when the property "when" is earlier than today', () => {
            const properties = {
        ...
        it('should save todo item with pending status when the property "when" is later than today', () => {
            const properties = {
                text: 'I must walk my dog',
